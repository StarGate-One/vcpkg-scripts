...
@set _VCPKG_LOG=%_VCPKG_GIT_LOGS_DIR%\vcpkg-list.log

@echo. >%_VCPKG_LOG%
@echo                                               Vcpkg Dynamic >>%_VCPKG_LOG%
@echo                                          List of Installed ports >>%_VCPKG_LOG%
...
rem
@%_VCPKG_TOOL_EXE% list >>%_VCPKG_LOG% 2>>&1
