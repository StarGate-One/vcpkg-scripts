...
@set _VCPKG_CMAKE_GEN="Visual Studio 17 2022"
@set _VCPKG_PLATFORM_TOOLSET=v143
...
@rem set VCPKG_DISABLE_COMPILER_TRACKING=ON
@set VCPKG_DISABLE_COMPILER_TRACKING=
@set VCPKG_DISABLE_METRICS=ON
@set VCPKG_DOWNLOADS=%_DEV_ROOT_DRV%\vcpkg-downloads
@set VCPKG_ENV_PASSTHROUGH=
@set VCPKG_ENV_PASSTHROUGH_UNTRACKED=CUDA_PATH;CUDA_PATH_V12_9;CUDA_TOOLKIT_ROOT;CUDA_TOOLKIT_ROOT_DIR;CUDNN_BIN_DIR;CUDNN_INCLUED_DIR;CUDNN_LIBRARY_DIR;CUDNN_ROOT_DIR;DevDivCodeAnalysisRunType;DOTNET_CLI_TELEMETRY_OPTOUT;DOTNET_TELEMETRY_OPTOUT;MSBUILDPRESERVETOOLTEMPFILES;POWERSHELL_CLI_TELEMETRY_OPTOUT;POWERSHELL_TELEMETRY_OPTOUT;VCPKG_ENV_PASSTHROUGH_UNTRACKED;VSCMD_SKIP_SENDTELEMETRY
